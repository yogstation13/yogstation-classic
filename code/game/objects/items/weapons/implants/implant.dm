...
/obj/item/weapon/implant/chemminer
	...
	desc = "Use this to keep your medicine regular. Scream to activate."
	allow_reagents = 1
	var/trans_amt = 50
	var/charges = 5
...
/obj/item/weapon/implant/chemminer/activate()
	if( reagents.total_volume )
		reagents.reaction( imp_in, INGEST )
		reagents.trans_to( imp_in, trans_amt )
