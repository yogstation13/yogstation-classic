/obj/item/weapon/contraband/poster/legit/wanted
	var/poster_desc
	icon_state = "rolled_poster"
	subtype = 2

/obj/item/weapon/contraband/poster/legit/wanted/New(turf/loc, icon/person_icon, wanted_name, description)
	..(loc)
...
/obj/structure/sign/poster/wanted/roll_and_drop(turf/location)
	var/obj/item/weapon/contraband/poster/legit/wanted/P = new(src, null, wanted_name, desc)//sadly I needed to copy-paste so I could send the extra args.
