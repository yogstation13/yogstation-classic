...
/proc/make_mining_asteroid_secret()
	...
	switch(pick(possiblethemes))//what kind of room is this gonna be?
		...
		if("cult")
			...
			treasureitems = list(/obj/item/device/soulstone=1, /obj/item/clothing/suit/space/hardsuit/cult=1, /obj/item/weapon/bedsheet/cult=2,
			...
			fluffitems = list(/obj/effect/gateway=1,/obj/effect/gibspawner=1,/obj/structure/cult/talisman=1,/obj/item/toy/crayon/red=2,
							  ...
							  /obj/item/clothing/head/helmet/space/hardsuit/cult=1, /obj/item/clothing/shoes/cult=1)
