			...
			if(!calibrated && prob(30 - ((accurate) * 10))) //oh dear a problem
				if(ishuman(M))//don't remove people from the round randomly you jerks
					...
					if(human.dna && human.dna.species.id == "human")
						...
						hardset_dna(human, null, null, null, null, /datum/species/fly/manfly)
						human.regenerate_icons()
					human.apply_effect((rand(120 - accurate * 40, 180 - accurate * 60)), IRRADIATE, 0)
					if(human.dna && human.dna.species.id == "lizard")
						M  << "<span class='italics'>You hear a buzzing in your ears.</span>"
						hardset_dna(human, null, null, null, null, /datum/species/fly/unafly)
						human.regenerate_icons()
					human.apply_effect((rand(120 - accurate * 40, 180 - accurate * 60)), IRRADIATE, 0)
					if(human.dna && human.dna.species.id == "android")
						M  << "<span class='italics'>You hear a buzzing in your ears.</span>"
						hardset_dna(human, null, null, null, null, /datum/species/fly/flyturnis)
						human.regenerate_icons()
					human.apply_effect((rand(120 - accurate * 40, 180 - accurate * 60)), IRRADIATE, 0)
					if(human.dna && human.dna.species.id == "plant")
						M  << "<span class='italics'>You hear a buzzing in your ears.</span>"
						hardset_dna(human, null, null, null, null, /datum/species/fly/flytosian)
						human.regenerate_icons()
					human.apply_effect((rand(120 - accurate * 40, 180 - accurate * 60)), IRRADIATE, 0)
