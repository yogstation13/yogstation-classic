			...
			if(boltsCut)
				...
				if(do_after(user,40,5,1))
					if(density && !operating)//Door must be closed to weld.
						...
						update_icon()
		return
	else if(((istype(C, /obj/item/weapon/melee/energy/sword)) || (istype(C, /obj/item/weapon/melee/energy/axe)) || (istype(C, /obj/item/weapon/twohanded/dualsaber))) && (!istype(C, /obj/item/weapon/twohanded/dualsaber/toy)))
