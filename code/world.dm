...
/world/proc/update_status()
	...
	s += "<b>[station_name()]</b>";
	s += " ("
	s += "<a href=\"http://www.yogstation.com\">" //Change this to wherever you want the hub to link to.
//	s += "[game_version]"
	s += "www.yogstation.com"  //Replace this with something else. Or ever better, delete it and uncomment the game version.
	s += "</a>"
	s += ")"
