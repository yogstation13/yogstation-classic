...
// RPM function to include compression friction - be advised that too low/high of a compfriction value can make things screwy
	...
	if(rpm>50000)
		overlays += image('icons/obj/atmospherics/simple.dmi', "comp-o4", FLY_LAYER)
	else if(rpm>10000)
		overlays += image('icons/obj/atmospherics/simple.dmi', "comp-o3", FLY_LAYER)
	else if(rpm>2000)
		overlays += image('icons/obj/atmospherics/simple.dmi', "comp-o2", FLY_LAYER)
	else if(rpm>500)
		overlays += image('icons/obj/atmospherics/simple.dmi', "comp-o1", FLY_LAYER)
	 //TODO: DEFERRED
...
// If it works, put an overlay that it works!
	...
	if(lastgen > 100)
		overlays += image('icons/obj/atmospherics/simple.dmi', "turb-o", FLY_LAYER)
