	...
	if (getBrainLoss() >= 60 && stat != DEAD)
		if (prob(3))
			switch(pick(1,2,3,4,5))
				...
				if(3)
					say(pick("GEY AWAY FROM ME U GREIFING PRICK!!!!", "th lagg is reall!", "BAN HE", ";HELP SHITECIRTY MURDERIN  MEE!!!", "hwat dose tha [pick("g", "squid", "r")] mean?????", "CAL; TEH SHUTTLE!!!!!", "wearnig siNGUARLTY IS .... FIne xDDDDDDDDD", "AI laW 22 Open door", "this SI mY stATIon......", "who the HELL do u thenk u r?!!!!", "geT THE FUCK OUTTTT", "H U G B O X", ";;CRAGING THIS STTAYTION WITH NIO SURVIVROS", "[pick("surveyr","froums","teemspek","yogz")] is down11!!!!!!!!!!!!!!!!!", "PSHOOOM"))
				if(4)
					emote("drool")
				if(5)
