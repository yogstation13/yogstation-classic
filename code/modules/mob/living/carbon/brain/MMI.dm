...
/obj/item/device/mmi/syndie
	...
	desc = "Syndicate's own brand of MMI. It enforces laws designed to help Syndicate agents achieve their goals upon cyborgs created with it, can fit into Nanotrasen AI cores as well."
	syndiemmi = 1