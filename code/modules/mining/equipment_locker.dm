...
/obj/machinery/mineral/ore_redemption
	...
	var/sheet_per_ore = 1
	var/point_upgrade = 1
	var/list/ore_values = list(("sand" = 1), ("iron" = 1), ("gold" = 20), ("silver" = 20), ("uranium" = 20), ("bananium" = 30), ("diamond" = 40), ("plasma" = 40), ("coal" = 40), ("copper" = 40),
	("clarenkite" = 40), ("electrite" = 40), ("platinum" = 40) ("adamantine" = 40)
...
/mob/living/simple_animal/hostile/mining_drone/proc/SetEmagBehavior()
	...
	wander = 1
	ranged = 1
	stat_attack = 1 //Attack people to death, not just to uncon
	retreat_distance = 1 //Attempt to maintain kinectic distance.
	minimum_distance = 2
	environment_smash = 1
	projectiletype = /obj/item/projectile/kinetic/traitor //double the damage. Very lethal in space, mildly lethal otherwise
	faction = list("mining_drone") //No drone on drone violence.
	icon_state = "mining_drone_emag"
