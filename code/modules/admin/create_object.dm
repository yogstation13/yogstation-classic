...
/datum/admins/proc/quick_create_object(var/mob/user)
	...
	pathtext = input("Select the path of the object you wish to create.", "Path", "/obj") in list("/obj","/obj/structure","/obj/effect","/obj/mecha","/obj/item","/obj/item/clothing","/obj/item/device","/obj/item/weapon","/obj/item/weapon/reagent_containers","/obj/item/weapon/storage","/obj/machinery")
