...
/obj/item/weapon/reagent_containers/food/snacks/sliceable/store/bread/rainbowmeat
	name = "rainbowmeatbread loaf"
	desc = "The density of the rainbow is so high you can see two of them"
	icon_state = "rainbowbread"
	slice_path = /obj/item/weapon/reagent_containers/food/snacks/breadslice/rainbowmeat

/obj/item/weapon/reagent_containers/food/snacks/breadslice/rainbowmeat
