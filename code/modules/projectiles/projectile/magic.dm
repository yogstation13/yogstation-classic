			...
			switch(randomize)
				...
				if("animal")
					if(prob(50))
						...
						var/animal = pick("parrot","corgi","crab","pug","cat","mouse","chicken","cow","lizard","chick","fox","gshepard")
						switch(animal)
							...
							if("gshepard") 	new_mob = new /mob/living/simple_animal/friendly/gshepherd(M.loc)
