...
/datum/reagent/unstableslimetoxin/on_mob_life(mob/living/carbon/human/H)
	...
	H.Weaken(3)
	sleep(30)
	var/list/blacklisted_species = list(/datum/species/zombie, /datum/species/skeleton, /datum/species/human, /datum/species/golem, /datum/species/golem/adamantine, /datum/species/shadow/ling, /datum/species/plasmaman, /datum/species) // shadow people are take off blacklist. hope this doesn't end terribly.
