...
/datum/mind/proc/edit_memory()
	...
	if (istype(current, /mob/living/carbon/human) || istype(current, /mob/living/carbon/monkey))
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_REV))
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_GANG))
...
*/
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_CULTIST))
			text += "|Enabled in Prefs"
		else
			text += "|Disabled in Prefs"
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_WIZARD))
			text += "|Enabled in Prefs"
		else
			text += "|Disabled in Prefs"
...
//				text += "<br>All the changelings are dead! Restart in [round((changeling.TIME_TO_GET_REVIVED-(world.time-changeling.changelingdeathtime))/10)] seconds."
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_CHANGELING))
			text += "|Enabled in Prefs"
		else
			text += "|Disabled in Prefs"
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_OPERATIVE))
			text += "|Enabled in Prefs"
		else
			text += "|Disabled in Prefs"
	...
	if(current && current.client && current.client.prefs.has_antag_pref(BE_TRAITOR))
		text += "|Enabled in Prefs"
	else
		text += "|Disabled in Prefs"
	...
	if(current && current.client && current.client.prefs.has_antag_pref(BE_SHADOWLING))
		text += "|Enabled in Prefs"
	else
		text += "|Disabled in Prefs"
	...
	if(current && current.client && current.client.prefs.has_antag_pref(BE_ABDUCTOR))
		text += "|Enabled in Prefs"
	else
		text += "|Disabled in Prefs"
	...
	if(current && current.client && current.client.prefs.has_antag_pref(BE_CYBERMAN))
		text += "|Enabled in Prefs"
	else
		text += "|Disabled in Prefs"
	...
	if (istype(current, /mob/living/carbon))
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_MONKEY))
			text += "|Enabled in Prefs"
		else
			text += "|Disabled in Prefs"
	...
	if (istype(current, /mob/living/silicon))
		...
		if(current && current.client && current.client.prefs.has_antag_pref(BE_MALF))
			text += "|Enabled in Prefs"
		else
			text += "|Disabled in Prefs"
