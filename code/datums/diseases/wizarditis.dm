...
/datum/disease/wizarditis/stage_act()
	...
	switch(stage)
		if(2)
			...
			if(prob(1)&&prob(50))
				affected_mob << "<span class='danger'>You feel [pick("that you don't have enough mana", "that the winds of magic are gone", "an urge to summon a familiar")].</span>"
		...
		if(3)
			...
			if(prob(1)&&prob(50))
				affected_mob << "<span class='danger'>You feel [pick("the magic bubbling in your veins","that this location gives you a +1 to INT","an urge to summon a familiar")].</span>"
